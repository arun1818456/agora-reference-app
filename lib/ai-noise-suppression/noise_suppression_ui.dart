...
import 'agora_manager_noise_suppression.dart';

class NoiseSuppressionScreen extends StatefulWidget {
  final ProductName selectedProduct;
  const NoiseSuppressionScreen({super.key, required this.selectedProduct});

  @override
  NoiseSuppressionScreenState createState() => NoiseSuppressionScreenState();
}

class NoiseSuppressionScreenState extends State<NoiseSuppressionScreen>
    with UiHelper {
  late AgoraManagerNoiseSuppression agoraManager;
  ...
  Future<void> initialize() async {
    ...
    agoraManager = await AgoraManagerNoiseSuppression.create(
