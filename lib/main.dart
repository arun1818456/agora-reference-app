import 'package:agora_voice_call/play-media/play_media_ui.dart';
import 'package:agora_voice_call/product-workflow/product_workflow_ui.dart';
import 'package:agora_voice_call/sdk-quickstart/sdk_quickstart_ui.dart';
import 'package:agora_voice_call/spatial-audio/spatial_audio_ui.dart';
import 'package:agora_voice_call/stream-raw-video-and-audio/raw_video_audio_ui.dart';
import 'package:agora_voice_call/virtual-background/virtual_background_ui.dart';
import 'package:flutter/material.dart';
import 'agora-manager/agora_manager.dart';
import 'agora-manager/ui_helper.dart';
import 'ai-noise-suppression/noise_suppression_ui.dart';
import 'audio-and-voice-effects/audio_voice_effects_ui.dart';
import 'authentication-workflow/authentication_workflow_ui.dart';
import 'cloud-proxy/cloud_proxy_ui.dart';
import 'custom-video-and-audio/custom_video_audio_ui.dart';
import 'ensure-channel-quality/call_quality_ui.dart';
import 'geofencing/geofencing_ui.dart';
import 'live-streaming-over-multiple-channels/multiple_channels_ui.dart';
import 'media-stream-encryption/media_stream_encryption_ui.dart';
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (index == 0 || filteredList[index - 1].category != example.category)
                  ListTile(
                    visualDensity:
...
//       appId: "872c6051efb049b781947eaeb4fdb5f6",
//       channelName: "test",
//       tempToken: token,
//     ),
//     enabledPermission: [
